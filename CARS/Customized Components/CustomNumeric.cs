...
namespace WinForms_NumUpDown
{
    ...
    public class CustomUpDown : Control
    {
        ...
        [Category("CustomUpDown"),
         Description("Gets or sets the default value in textBox"),
        ...
        public decimal Value
        {
            ...
            set
            {
                if (DecimalPlaces == 0)
                    valueLocal = value;
                else if (DecimalPlaces > 0 && DecimalPlaces < 7)
        ...
        [Category("CustomUpDown"),
         Description("Gets or sets the decimal places (max 6)")]
        ...
        [Category("CustomUpDown"),
         Description("Gets or sets the Maximum value (max 25 significant digits)")]
        ...
        [Category("CustomUpDown"),
         Description("Gets or sets the button repeat delay in milliseconds")]
        public int RepeatDelayMs { get; set; } = 100;

        [Category("CustomUpDown"),
         Description("Gets or sets the button fore color"),
         RefreshProperties(RefreshProperties.Repaint)]
        ...
        [Category("CustomUpDown"),
         Description("Gets or sets the button back color"),
         RefreshProperties(RefreshProperties.Repaint)]
        ...
        [Category("CustomUpDown"),
         Description("Gets or sets the textbox back color (default White), use ForeColor for the text color"),
         RefreshProperties(RefreshProperties.Repaint)]
        ...
        [Category("CustomUpDown"),
         Description("Gets or sets the Button display style"),
         RefreshProperties(RefreshProperties.Repaint)]
        ...
        [Category("CustomUpDown"),
         Description("Gets or sets the optional label text (with ForeColor as the color)"),
         RefreshProperties(RefreshProperties.Repaint)]
        public new string Text
        {
            ...
            set
            {
                if (!value.StartsWith("customUpDown"))
                    label1.Text = value;
